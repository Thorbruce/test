...
<link rel="stylesheet" type="text/css" href="{{ URL::asset('/lib/summernote/summernote.css') }}">
<script src="{{ URL::asset('/lib/summernote/summernote.js') }}"></script>
<script src="{{ URL::asset('/lib/summernote/lang/summernote-zh-CN.js') }}"></script>
<script>
