...
<head>
    ...
    <nav class="mui-bar mui-bar-tab" id="navfoot" >
		...
		<div data-v-69996b4c="" class="title">
			<p data-v-0b036123="" data-v-69996b4c="" align="center">新增送货地址</p>
		</div> 
		 <form class="mui-input-group" style="background:transparent;margin-top:2px;">         
            <div class="mui-input-row"> 		
               <input id="people" style="width:100%;text-indent:18px;" type="text"  class="mui-input-clear" placeholder="收货人">
            </div>
            <div class="mui-input-row ">                  
                <input id="phone" style="width:100%;text-indent:18px;" type="text"  class="mui-input-clear" placeholder="联系电话" >
            </div>
             <div class="mui-input-row ">
                 <select id="shen" style="width:30%;text-indent:18px;margin-left: 24px;height: 30px;margin-top: 5px;align-content: center;" class="mui-input-clear" onchange="shiqu();" onclick="one()">
                     <option id="s" style='text-align: center;'>省</option>
                 </select>
                 <select id="shi" style="width:30%;text-indent:18px;height: 30px;margin-top: 5px;align-content: center;" class="mui-input-clear" onchange="diqu();" onclick="two()">
                     <option id="x" style='text-align: center;'>市</option>
                 </select>
                 <select id="qu" style="width:30%;text-indent:18px;height: 30px;margin-top: 5px;align-content: center;" class="mui-input-clear" onclick="three()">
                     <option id="q" style='text-align: center;'>区/县</option>
                 </select>
             </div>
			<div class="mui-input-row ">                  
                <input id="address" style="width:100%;text-indent:18px;" type="text"  class="mui-input-clear" placeholder="详细地址" >
            </div>
...
<script type="application/javascript">
    ...
    $("#sub").click(function () {
        ...
        if(noNull(shenId,sshiId,quId,people,phone,address) == "ok"){
            $.ajax({
                url: '{{url("/assistant/user/addAddress")}}',
                type: 'post',
                data:
                    {
                        'shenId':shenId,
            ...
            switch(noNull(shenId,sshiId,quId,people,phone,address)) {
                case 0:
                    alert("省不能为空");
                    break;
                case 1:
