      ...
      <form class="mui-input-group" style="background:transparent;margin-top:2px;">
            ...
            <div class="mui-input-row">
               ...
               <span class="mui-icon mui-icon-contact inputfdongico"></span>
                ...
                <input id="phone" style="width:100%;text-indent:18px;" type="text"  class="mui-input-clear mtts" placeholder="您的手机/邮箱">
            </div>
            ...
            <div class="mui-input-row mui-password">
                ...
                <input id="pass"  style="width:100%;text-indent:18px;" type="password" class="mui-input-password" placeholder="新密码">
            </div>


            <button type="button" id="sub"  class=" mui-btn mui-btn-success mui-btn-block" style="width:98%;margin:20px
            auto 10px auto; ">重置密码</button>

        </form>

        <div class="mui-card-footer" >
					<a class="mui-card-link" href="{{url("/assistant/fasterLogin")}}">快捷登录</a>
					<a class="mui-card-link" href="{{url("/assistant/reg")}}">注册</a>
		</div>
